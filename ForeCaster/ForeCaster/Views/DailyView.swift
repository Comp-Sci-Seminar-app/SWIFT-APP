    ...
    var body: some View {
        ...
        ZStack{
            VStack{
                ...
                Text("\(dayInfo.detailedForecast)").background(Color.gray.opacity(0.6)).cornerRadius(7).frame(width: UIScreen.main.bounds.width - 60).font(.system(size: 20)).fixedSize(horizontal: false, vertical: true)
                Spacer()
